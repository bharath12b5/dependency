...
/**
 * An in memory Lucene index that contains the product list from the CPE (application) identifiers within the NVD CVE data.
 *
 * @author Jeremy Long
 */
public final class ProductIndex implements IndexInterface {
     ...
     * singleton instance.
     */
    private static final ProductIndex INSTANCE = new ProductIndex();
    ...
    /**
     * Creates an Analyzer for searching the Product Index.
     *
     * @return the CPE Analyzer.
     */
    @SuppressWarnings("unchecked")
     ...
     */
    public void saveEntry(String product, IndexWriter indexWriter) throws CorruptIndexException, IOException {
    ...
    private void buildIndex(CveDB cve) throws IndexException {
        ...
        try {
            ...
            try {
                for (String product : cve.getProductList()) {
                    saveEntry(product, indexWriter);
                }
